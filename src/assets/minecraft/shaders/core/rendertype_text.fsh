...
#moj_import <minecraft:globals.glsl> // genesis
...
in vec4 vertexColor;
in vec2 texCoord0;
in float height; // genesis
in float isShadow; // genesis
in float customType; // genesis
